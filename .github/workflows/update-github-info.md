...
4. Use the GitHub repository API tools for all repository guidance and reference-file reads. Do not use terminal, CLI, shell, or sandboxed commands for GitHub API reads.
5. Read `site/content/github-info.md` before editing it.

## Task

Use the official GitHub Blog and Changelog sources to make concise, practical updates in `site/content/github-info.md`. Preserve the existing editorial angle, mention the source for every blog or changelog item, and avoid inventing details. Keep the page useful for developers learning GitHub faster.
